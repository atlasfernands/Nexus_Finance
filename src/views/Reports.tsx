...
export default function Reports() {
  ...
  const trendData = buildTrendData(state.transactions, selectedPeriod);
  const comparisonData = buildComparisonData(transactions);
  const exportCSV = () => downloadTransactionsCsv(transactions);
  ...
  const negativeReasonLabel = firstNegativePendingEvent
    ...
    : null;
  const upcomingPayments = buildUpcomingPayments(upcomingPendingExpenses);
    ...
    <div className="space-y-6">
      ...
      <div className="trading-card">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          <button
            onClick={() => downloadTransactionsJson(transactions)}
